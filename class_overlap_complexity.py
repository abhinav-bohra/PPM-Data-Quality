...
class MFEComplexity:
    ...
    def ft_f1(
        ...
        # calculated as:
        f1_all = 1.0 / (1.0 + attr_discriminant_ratio)
        f1_max = 1.0 / (1.0 + np.max(attr_discriminant_ratio))
        f1_nanmax = 1.0 / (1.0 + np.nanmax(attr_discriminant_ratio))

        return f1_all, f1_max, f1_nanmax
